...
RSpec.describe 'Rentals API', js: true, type: :request do
  before(:all) do
    ...
    @rental1 = Rental.create(start_date: '10-12-2021', end_date: '22-12-2021', city: 'Medellin', user_id: @user1.id,
                             car_id: @car1.id)
    @rental2 = Rental.create(start_date: '15-12-2021', end_date: '10-01-2022', city: 'Lima', user_id: @user1.id,
                             car_id: @car2.id)
  ...
  describe 'GET /v1/rentals' do
    before do
      get '/v1/rentals', params: {}, headers: { Authorization: JsonWebToken.encode({ user_id: User.first.id }) }
    end
  ...
  describe 'POST /v1/rentals' do
    ...
    context 'when the request is valid' do
      before do
        post '/v1/rentals', params: new_rental,
